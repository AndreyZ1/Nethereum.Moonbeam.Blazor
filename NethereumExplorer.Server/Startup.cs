...
namespace NethereumExplorer.Server
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<NetworkConfigurationModel>(Configuration.GetSection("NetworkConfiguration"));
            var networkConfigurationModel = new NetworkConfigurationModel { Url = Configuration.GetSection("NetworkConfiguration")["Url"], ChainId = Configuration.GetSection("NetworkConfiguration")["ChainId"] };
            IOptions<NetworkConfigurationModel> networkConfigurationModelOption = Options.Create(networkConfigurationModel);

            var web3ServiceProvider = new Web3ProviderService(networkConfigurationModelOption);
